...
const Recently: React.FC<Props> = ({ track, message }) => {
    ...
    return (
        <>
            ...
            <div className='w-full flex flex-row md:grid grid-cols-6 lg:grid-cols-4 md:pb-7 gap-3 pb-0 md:gap-4 px-4 overflow-auto md:overflow-hidden snap-x no-scrollbar'>
                {
